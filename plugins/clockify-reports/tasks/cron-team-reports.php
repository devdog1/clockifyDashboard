<?php
/**
 * Clockify Task: Automated Team Summary Email Report
 */
...
<body>
    ...
    <?php foreach ($teams as $team): ?>
        ...
        renderTaskTable($weekly);
        echo "<h3>User Breakdown</h3>";
        renderTaskUserTable($weekly);
        ?>
        ...
        echo "<h3>Project Totals</h3>";
        renderTaskTable($fytd);
        echo "<h3>User Breakdown</h3>";
        renderTaskUserTable($fytd);
        ?>
...
function renderTaskUserTable($data) {
